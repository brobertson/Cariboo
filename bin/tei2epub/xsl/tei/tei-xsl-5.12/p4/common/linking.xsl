...
<xsl:stylesheet exclude-result-prefixes="xd tei edate"
  ...
  <xd:doc type="stylesheet">
    ...
    <xd:cvsId>$Id: linking.xsl 4533 2008-04-10 14:17:21Z rahtz $</xd:cvsId>
  ...
  <xd:doc>
    <xd:short>Process elements anchor|p in xref mode</xd:short>
    <xd:detail> </xd:detail>
  </xd:doc>
  ...
  <xd:doc>
    <xd:short>Process elements
      div|div0|div1|div2|div3|div4|div5|div6 in
      xref mode</xd:short>
  ...
  <xd:doc>
    <xd:short>Process elements ptr|xptr in xref mode</xd:short>
    <xd:detail> </xd:detail>
  </xd:doc>
