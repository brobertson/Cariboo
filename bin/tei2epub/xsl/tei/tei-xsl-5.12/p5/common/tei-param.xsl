...
<xsl:stylesheet exclude-result-prefixes="edate xd"
  ...
  <xd:doc type="stylesheet">
    ...
    <xd:cvsId>$Id: tei-param.xsl 4572 2008-05-17 15:20:00Z rahtz $</xd:cvsId>
  ...
  <xsl:template name="numberBackDiv">
    <xsl:if test="not($numberBackHeadings='')">
      <xsl:number
        count="tei:div1"
        format="A.1.1.1.1.1" level="multiple"/><!--tei:div|tei:div0|...|tei:div2|tei:div3|tei:div4|tei:div5|tei:div6-->
    </xsl:if>
  </xsl:template>
  ...
  <xsl:template name="numberBodyDiv">
    <xsl:if test="$numberHeadings='true'">
      <xsl:number
        count="tei:div1"
        level="multiple"/><!--tei:div|tei:div0|...tei:div2|tei:div3|tei:div4|tei:div5|tei:div6-->
    </xsl:if>
  </xsl:template>
  <xd:doc class="numbering" type="string"> How to construct heading numbering in
    main matter</xd:doc>
  ...
  <xd:doc class="numbering" type="integer"> Depth to which sections should be
    numbered</xd:doc>
  <xsl:param name="numberHeadingsDepth">1<!--9--></xsl:param>
  ...
  <xd:doc class="numbering" type="boolean"> Use value of "n" attribute to number
    sections</xd:doc>
  <xsl:param name="prenumberedHeadings">true<!--false--></xsl:param>
