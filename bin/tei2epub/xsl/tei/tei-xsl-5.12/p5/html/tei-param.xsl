...
<xsl:stylesheet 
  ...
  <xd:doc type="stylesheet">
    ...
    <xd:cvsId>$Id: tei-param.xsl 4564 2008-05-07 01:59:48Z dsew $</xd:cvsId>
...
Include the back matter in the table of contents.
  ...
  <xsl:param name="tocBack">false <!--true--></xsl:param>
  <xd:doc type="string" class="toc">
Depth to which table of contents is constructed.
</xd:doc>
  <xsl:param name="tocDepth">1<!--5--></xsl:param>
  <xd:doc type="boolean" class="toc">
...
Which HTML element to wrap each TOC sections in.
  ...
  <xsl:param name="tocContainerElement">div1</xsl:param>
