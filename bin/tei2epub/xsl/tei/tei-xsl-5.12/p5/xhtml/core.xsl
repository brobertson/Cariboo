...
<xsl:apply-templates/>
  ...
  <xd:doc>
<xd:short>Process elements tei:milestone chapter</xd:short>
    <xd:detail> </xd:detail>
  </xd:doc>
...
<xd:doc>
<xd:short>Process elements tei:milestone para</xd:short>
    <xd:detail> </xd:detail>
  </xd:doc>
...
<xsl:apply-templates/>
 ...
 <xd:doc>
<xd:short>Process elements tei:milestone verse</xd:short>
    <xd:detail> </xd:detail>
  </xd:doc>
...
<xsl:apply-templates/>
  ...
  <xsl:template match="tei:p">
	...
	<xsl:with-param name="default">
      ...
      <xsl:choose>
        <!-- This rule causes multiple duplicate IDs to be generated in
        the same document, which is valid XHTML 1.0 (they are not @xml:ids but HTML ids) 
        but not 1.1. Commented out by liza 2008-05-19 
        -->
