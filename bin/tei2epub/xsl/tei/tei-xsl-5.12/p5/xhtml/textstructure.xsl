...
-->
  ...
  <xsl:template match="tei:div[@type='canto']">
    ...
    <xsl:element name="h{$divlevel + $divOffset}"><xsl:attribute name="hieverybody">xhtml557</xsl:attribute>
  ...
  <xsl:template name="doBody">
    ...
    <xsl:choose>
      <xsl:when test="parent::tei:div/@rend='multicol'">
        <td valign="top">
          <xsl:if test="not($Head = '')">
            <xsl:element name="h{$Head + $divOffset}"><xsl:attribute name="hieverybody">xhtml938</xsl:attribute>
      ...
      <xsl:otherwise>
        <xsl:if test="not($Head = '')">
          <xsl:element name="h{$Head + $divOffset}"><xsl:attribute name="hieverybody">xhtml960</xsl:attribute>
            <xsl:if test="$xhtml='false'">
              <a name="{$ident}"/>
            </xsl:if>
            <xsl:call-template name="header">
